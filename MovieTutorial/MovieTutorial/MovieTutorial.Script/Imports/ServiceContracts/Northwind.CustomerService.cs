namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/Customer";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/Customer/Create";
            [InlineConstant]
            public const string Update = "Northwind/Customer/Update";
            [InlineConstant]
            public const string Delete = "Northwind/Customer/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/Customer/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/Customer/List";
        }
    }
