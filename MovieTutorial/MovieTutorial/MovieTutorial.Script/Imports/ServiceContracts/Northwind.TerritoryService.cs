namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/Territory";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/Territory/Create";
            [InlineConstant]
            public const string Update = "Northwind/Territory/Update";
            [InlineConstant]
            public const string Delete = "Northwind/Territory/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/Territory/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/Territory/List";
        }
    }
