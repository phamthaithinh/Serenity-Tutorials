namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/Category";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/Category/Create";
            [InlineConstant]
            public const string Update = "Northwind/Category/Update";
            [InlineConstant]
            public const string Delete = "Northwind/Category/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/Category/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/Category/List";
        }
    }
