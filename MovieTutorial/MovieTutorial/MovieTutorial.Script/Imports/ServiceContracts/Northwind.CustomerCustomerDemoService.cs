namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/CustomerCustomerDemo";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/CustomerCustomerDemo/Create";
            [InlineConstant]
            public const string Update = "Northwind/CustomerCustomerDemo/Update";
            [InlineConstant]
            public const string Delete = "Northwind/CustomerCustomerDemo/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/CustomerCustomerDemo/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/CustomerCustomerDemo/List";
        }
    }
