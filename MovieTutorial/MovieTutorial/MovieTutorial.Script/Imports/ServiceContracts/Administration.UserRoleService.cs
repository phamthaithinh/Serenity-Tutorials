namespace MovieTutorial.Administration
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Administration/UserRole";
        ...
        {
            [InlineConstant]
            public const string Update = "Administration/UserRole/Update";
            [InlineConstant]
            public const string List = "Administration/UserRole/List";
        }
    }
