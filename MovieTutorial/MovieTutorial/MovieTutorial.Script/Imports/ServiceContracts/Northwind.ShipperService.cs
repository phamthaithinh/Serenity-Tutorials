namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/Shipper";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/Shipper/Create";
            [InlineConstant]
            public const string Update = "Northwind/Shipper/Update";
            [InlineConstant]
            public const string Delete = "Northwind/Shipper/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/Shipper/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/Shipper/List";
        }
    }
