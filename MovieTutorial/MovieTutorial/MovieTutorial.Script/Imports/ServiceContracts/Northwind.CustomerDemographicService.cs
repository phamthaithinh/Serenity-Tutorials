namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/CustomerDemographic";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/CustomerDemographic/Create";
            [InlineConstant]
            public const string Update = "Northwind/CustomerDemographic/Update";
            [InlineConstant]
            public const string Delete = "Northwind/CustomerDemographic/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/CustomerDemographic/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/CustomerDemographic/List";
        }
    }
