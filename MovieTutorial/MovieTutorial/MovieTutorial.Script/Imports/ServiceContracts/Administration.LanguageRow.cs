...
namespace MovieTutorial.Administration
{
    ...
    public partial class LanguageRow
    {
        ...
        [InlineConstant]
        public const string NameProperty = "LanguageName";
        [InlineConstant]
        public const string LocalTextPrefix = "Administration.Language";
        [InlineConstant]
        public const string LookupKey = "Administration.Language";
