namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/Product";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/Product/Create";
            [InlineConstant]
            public const string Update = "Northwind/Product/Update";
            [InlineConstant]
            public const string Delete = "Northwind/Product/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/Product/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/Product/List";
        }
    }
