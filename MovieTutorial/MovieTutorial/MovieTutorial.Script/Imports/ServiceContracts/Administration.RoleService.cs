namespace MovieTutorial.Administration
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Administration/Role";
        ...
        {
            [InlineConstant]
            public const string Create = "Administration/Role/Create";
            [InlineConstant]
            public const string Update = "Administration/Role/Update";
            [InlineConstant]
            public const string Delete = "Administration/Role/Delete";
            [InlineConstant]
            public const string Retrieve = "Administration/Role/Retrieve";
            [InlineConstant]
            public const string List = "Administration/Role/List";
        }
    }
