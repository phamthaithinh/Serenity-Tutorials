namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/Supplier";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/Supplier/Create";
            [InlineConstant]
            public const string Update = "Northwind/Supplier/Update";
            [InlineConstant]
            public const string Delete = "Northwind/Supplier/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/Supplier/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/Supplier/List";
        }
    }
