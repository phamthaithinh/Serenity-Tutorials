namespace MovieTutorial.Administration
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Administration/RolePermission";
        ...
        {
            [InlineConstant]
            public const string Update = "Administration/RolePermission/Update";
            [InlineConstant]
            public const string List = "Administration/RolePermission/List";
        }
    }
