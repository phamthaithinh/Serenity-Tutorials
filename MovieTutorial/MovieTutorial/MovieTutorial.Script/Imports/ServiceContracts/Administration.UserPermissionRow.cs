...
namespace MovieTutorial.Administration
{
    ...
    {
        [InlineConstant]
        public const string IdProperty = "UserPermissionId";
        [InlineConstant]
        public const string NameProperty = "PermissionKey";
        [InlineConstant]
        public const string LocalTextPrefix = "Administration.UserPermission";
