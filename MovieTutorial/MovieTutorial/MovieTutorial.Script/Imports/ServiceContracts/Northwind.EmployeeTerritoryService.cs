namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/EmployeeTerritory";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/EmployeeTerritory/Create";
            [InlineConstant]
            public const string Update = "Northwind/EmployeeTerritory/Update";
            [InlineConstant]
            public const string Delete = "Northwind/EmployeeTerritory/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/EmployeeTerritory/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/EmployeeTerritory/List";
        }
    }
