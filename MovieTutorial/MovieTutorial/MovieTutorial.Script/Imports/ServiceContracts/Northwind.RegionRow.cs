...
namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string IdProperty = "RegionID";
        [InlineConstant]
        public const string NameProperty = "RegionDescription";
        [InlineConstant]
        public const string LocalTextPrefix = "Northwind.Region";
        [InlineConstant]
        public const string LookupKey = "Northwind.Region";
