namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/Region";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/Region/Create";
            [InlineConstant]
            public const string Update = "Northwind/Region/Update";
            [InlineConstant]
            public const string Delete = "Northwind/Region/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/Region/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/Region/List";
        }
    }
