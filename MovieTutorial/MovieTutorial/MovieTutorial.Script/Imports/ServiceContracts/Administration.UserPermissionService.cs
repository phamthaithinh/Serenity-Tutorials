namespace MovieTutorial.Administration
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Administration/UserPermission";
        ...
        {
            [InlineConstant]
            public const string Update = "Administration/UserPermission/Update";
            [InlineConstant]
            public const string List = "Administration/UserPermission/List";
            [InlineConstant]
            public const string ListPermissionKeys = "Administration/UserPermission/ListPermissionKeys";
        }
    }
