namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/Employee";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/Employee/Create";
            [InlineConstant]
            public const string Update = "Northwind/Employee/Update";
            [InlineConstant]
            public const string Delete = "Northwind/Employee/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/Employee/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/Employee/List";
        }
    }
