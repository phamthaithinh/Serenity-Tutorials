namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/Order";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/Order/Create";
            [InlineConstant]
            public const string Update = "Northwind/Order/Update";
            [InlineConstant]
            public const string Delete = "Northwind/Order/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/Order/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/Order/List";
        }
    }
