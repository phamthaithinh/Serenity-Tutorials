namespace MovieTutorial.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/OrderDetail";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/OrderDetail/Create";
            [InlineConstant]
            public const string Update = "Northwind/OrderDetail/Update";
            [InlineConstant]
            public const string Delete = "Northwind/OrderDetail/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/OrderDetail/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/OrderDetail/List";
        }
    }
