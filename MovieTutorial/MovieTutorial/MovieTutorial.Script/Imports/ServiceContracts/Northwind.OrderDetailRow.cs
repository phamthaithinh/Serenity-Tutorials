...
namespace MovieTutorial.Northwind
{
    ...
    public partial class OrderDetailRow
    {
        ...
        [InlineConstant]
        public const string LocalTextPrefix = "Northwind.OrderDetail";
        ...
        public static class Fields
        {
            ...
            [InlineConstant]
            public const string OrderEmployeeID = "OrderEmployeeID";
            [InlineConstant]
            public const string OrderOrderDate = "OrderOrderDate";
            [InlineConstant]
            public const string OrderRequiredDate = "OrderRequiredDate";
            [InlineConstant]
            public const string OrderShippedDate = "OrderShippedDate";
            [InlineConstant]
            public const string OrderShipVia = "OrderShipVia";
            [InlineConstant]
            public const string OrderFreight = "OrderFreight";
            [InlineConstant]
            public const string OrderShipName = "OrderShipName";
            [InlineConstant]
            public const string OrderShipAddress = "OrderShipAddress";
            [InlineConstant]
            public const string OrderShipCity = "OrderShipCity";
            [InlineConstant]
            public const string OrderShipRegion = "OrderShipRegion";
            [InlineConstant]
            public const string OrderShipPostalCode = "OrderShipPostalCode";
            [InlineConstant]
            public const string OrderShipCountry = "OrderShipCountry";
            [InlineConstant]
            public const string ProductProductName = "ProductProductName";
            [InlineConstant]
            ...
            [InlineConstant]
            public const string ProductQuantityPerUnit = "ProductQuantityPerUnit";
            [InlineConstant]
            public const string ProductUnitPrice = "ProductUnitPrice";
            [InlineConstant]
            public const string ProductUnitsInStock = "ProductUnitsInStock";
            [InlineConstant]
            public const string ProductUnitsOnOrder = "ProductUnitsOnOrder";
            [InlineConstant]
            public const string ProductReorderLevel = "ProductReorderLevel";
        }
    }
